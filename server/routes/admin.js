import { getAdminAttendanceByDate } from '../controllers/attendanceController.js';
...
import { exportOmrXlsx, exportMerchXlsx, exportProductivityXlsx, exportOmrOutletHistoryXlsx, exportOmrOutletUniverseXlsx, exportDataAnalysisXlsx } from '../controllers/exportController.js';
import {
  getAdminAvcGallery,
  deleteAvcPhoto,
...
router.get('/export/data-analysis', exportDataAnalysisXlsx);
